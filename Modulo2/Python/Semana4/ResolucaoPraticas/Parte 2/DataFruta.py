...
def main():
    ...
    print("__________ITERADORES EM PYTHON__________")
    ...
    print("---MAP---")
    folhaPagamento = 0.0
    for i in map(lambda x: x*1.1,salarios):
        folhaPagamento+=i
    print(f"Valor folha de pagamento após o reajuste de 10% = {folhaPagamento} ")
