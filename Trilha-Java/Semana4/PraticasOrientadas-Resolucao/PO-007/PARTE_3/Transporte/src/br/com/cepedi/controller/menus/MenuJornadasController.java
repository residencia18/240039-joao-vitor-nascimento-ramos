...
public abstract class MenuJornadasController {
	...
	public static void selecionarAcao(Scanner sc, ListaJornadas jornadas , ListaFuncionarios funcionarios ,
		...
		do {
			...
			case 1:
				...
				PersistenciaJornadas.salvarArquivo(jornadas, listaJornadaTrajetoHorario);
				break;
			case 2:
				mostra(sc,jornadas);
				break;
			...
			case 4:
				exclui(sc,jornadas);
				PersistenciaJornadas.salvarArquivo(jornadas);
				break;
			case 5:
	...
	private static void exclui(Scanner sc , ListaJornadas jornadas) {
		...
		do {
			try {
				System.out.println("Digite o id da jornada que deseja excluir");
				idJornada = Integer.parseInt(sc.nextLine());
