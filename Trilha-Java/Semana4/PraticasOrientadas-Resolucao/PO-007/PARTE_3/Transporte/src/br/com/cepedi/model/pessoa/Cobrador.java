...
public class Cobrador extends Funcionario implements Serializable{
	...
	public Cobrador(int id ,String nome, String CPF, BigDecimal salario) throws NomePessoaInvalidoException, CPFPessoaInvalidoException, SalarioFuncionarioInvalidoException {
