...
public class Motorista extends Funcionario implements Serializable{
	...
	public Motorista(int id , String nome, String CPF, String salario, String CNH) throws NomePessoaInvalidoException, CPFPessoaInvalidoException, SalarioFuncionarioInvalidoException, CNHMotoristaInvalidaException {
		super(id ,nome, CPF, salario);
		setCNH(CNH);
	}
	
	public Motorista(int id , String nome, String CPF, BigDecimal salario, String CNH) throws NomePessoaInvalidoException, CPFPessoaInvalidoException, SalarioFuncionarioInvalidoException, CNHMotoristaInvalidaException {
		super(id ,nome, CPF, salario);
		setCNH(CNH);
	}
