...
public class Passageiro extends Pessoa  implements Serializable{
	...
	public Passageiro(int id, String nome, String CPF, CartaoPassagem cartao) throws NomePessoaInvalidoException, CPFPessoaInvalidoException, CartaoInvalidoException {
		super(id,nome, CPF);
		setCartao(cartao);
	}
	...
	public Passageiro(int id, String nome, String CPF , int cartao) throws NomePessoaInvalidoException, CPFPessoaInvalidoException, CartaoInvalidoException, TipoDePassagemInvalidoException {
		super(id,nome, CPF);
		setCartao(new CartaoPassagem(cartao));
	}
