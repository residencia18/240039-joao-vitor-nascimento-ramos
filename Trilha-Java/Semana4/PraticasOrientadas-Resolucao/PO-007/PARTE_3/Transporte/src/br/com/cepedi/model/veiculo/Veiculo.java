...
public class Veiculo  implements Serializable{
	...
	public static int numeroDeVeiculos = 0;
	private int id;
	...
	public Veiculo(int id , String modelo, String placa, String montadora) throws modeloVeiculoInvalidoException, montadoraVeiculoInvalidaException, placaVeiculoInvalidaException {
		super();
		setModelo(modelo);
		setMontadora(montadora);
		setPlaca(placa);
