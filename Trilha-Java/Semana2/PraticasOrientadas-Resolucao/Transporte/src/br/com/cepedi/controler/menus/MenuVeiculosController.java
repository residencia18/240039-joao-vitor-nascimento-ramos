...
public abstract class MenuVeiculosController {
	...
	public static void selecionarAcao(Scanner sc, ListaVeiculos veiculos) {
		...
		do {
			...
			switch(escolha) {
			case 1:
				cadastraVeiculo(sc,veiculos);
				break;
			case 2:
				mostraVeiculo(sc,veiculos);
				break;
			case 3:
				listaTodosVeiculos(veiculos);
				break;
			case 4:
				excluiVeiculo(sc,veiculos);
				break;
			case 0:
				break;
	...
	private static void cadastraVeiculo(Scanner sc , ListaVeiculos veiculos) {
	...
	private static void mostraVeiculo(Scanner sc , ListaVeiculos veiculos) {
		Veiculo veiculo = null;
		String placa;
		String escolhaContinue = "";
		do {
	...
	private static void listaTodosVeiculos(ListaVeiculos veiculos) {
		veiculos.mostraTodos();
	}
	
	private static void excluiVeiculo(Scanner sc , ListaVeiculos veiculos) {
		String placa;
		String escolhaContinue = "";
		do {
			try {
