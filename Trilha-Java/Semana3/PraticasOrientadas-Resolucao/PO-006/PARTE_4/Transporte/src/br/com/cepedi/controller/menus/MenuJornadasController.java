...
public abstract class MenuJornadasController {
	...
	public static void selecionarAcao(Scanner sc, ListaJornadas jornadas , ListaFuncionarios funcionarios ,
			ListaTrajetos trajetos ,  ListaVeiculos veiculos , ListaJornadaTrajetoHorario listaJornadaTrajetoHorario, String CAMINHO_ARQUIVO_JORNADAS) {
		...
		do {
			...
			case 1:
				...
				Persistencia.salvarEmArquivo(jornadas,CAMINHO_ARQUIVO_JORNADAS);
				Persistencia.salvarEmArquivo(listaJornadaTrajetoHorario,listaJornadaTrajetoHorario.CAMINHO_ARQUIVO);
				break;
			case 2:
				mostra(sc,jornadas);
				break;
