...
public abstract class MenuTrajetosController {
	...
	public static void selecionarAcao(Scanner sc, ListaTrajetos trajetos , ListaTrechos trechos, ListaPontosDeParada pontos, String CAMINHO_ARQUIVO) {
		...
		do {
			...
			case 1:
				...
				Persistencia.salvarEmArquivo(trajetos,CAMINHO_ARQUIVO);
				break;
			case 2:
				mostra(sc,trajetos);
				break;
